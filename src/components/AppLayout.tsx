      ...
      <aside className="hidden md:flex w-64 flex-col bg-sidebar text-sidebar-foreground border-r border-sidebar-border">
        <div className="px-6 py-6 border-b border-sidebar-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-serif text-xl font-semibold leading-tight">Lex Office</h1>
              <p className="text-xs text-sidebar-foreground/60">Servicios Jurídicos</p>
            </div>
          </div>
        </div>
      ...
      <div className="md:hidden fixed top-0 inset-x-0 z-40 bg-sidebar text-sidebar-foreground border-b border-sidebar-border">
        <div className="flex items-center justify-between px-4 py-3">
          <div className="flex items-center gap-2">
            ...
            <span className="font-serif text-lg">Lex Office</span>
          </div>
